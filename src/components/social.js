    ...
    render() {
        ...
        return(
            <div className="socialContainer">
                ...
                >
                    <img className='socialImg' src={fbimg}/>
                </button>
                <button className='socialButton'
                        title='Twitter Page'
                        onClick={(e): void => {
                ...
                >
                    <img className='socialImg' src={twitterimg}/>
                </button>
                <button className='socialButton'
                ...
                >
                    <img className='socialImg' src={igimg}/>
                </button>
                <button className='socialButton'
                        title='LinkedIn'
                        onClick={(e): void => {
                ...
                >
                    <img className='socialImg' src={linkedinimg}/>
                </button>
                <button className='socialButton'
                ...
                >
                    <img className='socialImg' src={youtubeimg}/>
                </button>
                <button className='socialButton'
                ...
                >
                    <img className='socialImg' src={slackimg}/>
                </button>
            </div>
        )
    }
